                    ...
                    <table class="table table-sm table-striped table-bordered">
                        ...
                        <tbody>
                                ...
                                <tr>
                                  ...
                                  <!-- reject model -->
                                  <div class="modal fade" id="status_model_bill{{ $paymentStore->id }}" tabindex="-1" aria-labelledby="statusLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="status_model_bill">तपाईं यसलाई किन अस्वीकार गर्दै हुनुहुन्छ?</h5>
