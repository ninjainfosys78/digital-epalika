            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">पालिका विवरण सम्पादन गर्नुहोस्</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">पालिका विवरण सम्पादन गर्नुहोस्</h4>
                ...
                <div class="card-body">
                    <form action="{{route('admin.global.website.municipalDetail.update', $municipalDetail)}}" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="title"
                                    value="{{old('title',$municipalDetail->title)}}"
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="icon"
                                    value="{{old('icon',$municipalDetail->icon)}}"
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input
                                    type="color"
                                    name="bg_color"
                                    value="{{old('bg_color',$municipalDetail->bg_color)}}"
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="count"
                                    value="{{old('count',$municipalDetail->count)}}"
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input
                                    type="number"
                                    name="position"
                                    value="{{old('position',$municipalDetail->position)}}"
