                    ...
                    <form action="{{route('admin.global.generalSetting.emergencyNumber.update',$emergencyNumber)}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input id="contact_person_name" type="text" name="contact_person_name"
                                       placeholder="सम्पर्क व्यक्ति"
                                       class="form-control @error('contact_person_name') is-invalid @enderror"
                                       value="{{ old('contact_person_name', $emergencyNumber->contact_person_name ?? '') }}">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input id="longitude" type="text" name="longitude" placeholder="देशान्तर"
                                       ...
                                       value="{{ old('longitude', $emergencyNumber->longitude ?? '') }}">
                                @error('longitude')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
