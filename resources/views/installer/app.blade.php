...
<div class="master">
    <div class="box">
        ...
        <ul class="step">
            ...
            <li class="step__item {{request()->routeIs('installer.final') ? 'active' : ''}}">
                <i class="step__icon fa fa-server" aria-hidden="true"></i>
            </li>
            <li class="step__divider"></li>
            <li class="step__item {{request()->routeIs('installer.environment-wizard') ? 'active' : ''}}">
                @if(Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                    <a href="{{ route('installer.environment-wizard') }}">
            ...
            <li class="step__divider"></li>
            <li class="step__item {{request()->routeIs('installer.permissions') ? 'active' : ''}}">
            ...
            <li class="step__divider"></li>
            <li class="step__item {{request()->routeIs('installer.welcome') ? 'active' : ''}}">
