...
<body class="authentication-bg bg-main">
<div class="mt-5 mb-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-11">
                <div class="text-center">
                    ...
                    <h3 class="mt-4 text-white">हामी हाल मर्मत सम्भार गर्दैछौं ।</h3>
                    <p class="text-white-50">हामी प्रणालीलाई अझ उत्कृष्ट बनाउँदैछौं। हामी छिट्टै फर्कने छौँ ।</p>
                </div>
            </div>
        </div>
    </div>
