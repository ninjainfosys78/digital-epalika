                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <div class="text-center">
                            <h3 class="mt-4">पृष्ठ फेला परेन</h3>
                            <h4 class="text-muted mb-0">तपाईंले गलत मोड लिनुभएको हुनसक्छ जस्तो देखिन्छ। चिन्ता नगर्नुहोस् ... यो हुन्छ।</h4>
                        </div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <h4 class="text-white-50"><a href="{{auth()->check() ? route('admin.dashboard') : route('welcome')}}" class="text-white me-1"><b>गृह पृष्ठमा</b></a> फर्कनुहोस्</h4>
                    </div>
                </div>
            </div>
        </div>
