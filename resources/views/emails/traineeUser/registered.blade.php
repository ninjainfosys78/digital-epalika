...
<head>
    ...
    <title>Digital E-Palika ई-नक्सा संगठन पासवर्ड सेट</title>
</head>
                ...
                <table class="main" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        <td class=""
                            ...
                            <a href="#"> <img src="{{asset(config('app.logo'))}}" height="24" alt="logo"/></a> <br/>
                        </td>
                    </tr>
                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        बधाई छ, हाम्रो प्रणालीमा दर्ता हुने तपाईंको अनुरोध सफलतापूर्वक स्वीकार गरिएको छ। पासवर्ड सेट अप गर्न तलको बटनमा क्लिक गर्नुहोस्
                                    </td>
                                </tr>
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                        valign="top">
                                        Thanks for choosing <b>Digital E-Palika</b>  {{ config('app.name') }}.
                                    </td>
                                </tr>
                            </table>
                        </td>
