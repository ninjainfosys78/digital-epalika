        ...
        <div class="col-md-12">
            <div class="card p-0">
                ...
                <div class="card-body px-0">
                    <form action="{{ route('admin.plan.fuelDemand.store') }}" method="post">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select name="equipment_id"
                                        class="form-control @error('equipment_id') is-invalid @enderror" id="equipment_id"
                                        data-toggle="select2" data-width="100%" required>
                                        <option value="">--- छान्नुहोस् ---</option>
                                        @foreach ($equipments as $equipment)
                                            <option {{ old('equipment_id') == $equipment->id ? 'selected' : '' }}
                                                value="{{ $equipment->id }}">
                                                {{ $equipment->title }}
                                            </option>
                                        @endforeach
