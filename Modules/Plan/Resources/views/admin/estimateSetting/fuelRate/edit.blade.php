    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.plan.fuelRate.update',$fuelRate)}}" method="post">
                        @csrf
                        @method('put')
                        <fieldset class="mb-2">
                            <legend> विवरण</legend>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select
                                        ...
                                        @foreach($fuels as $fuel)
                                            <option
                                                {{old('fuel_id',$fuel->id)== $fuelRate->fuel_id? 'selected' : ''}}
                                                value="{{$fuel->id}}">
                                                {{$fuel->title}}
                                            </option>
                                        @endforeach
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="radio" id="yes" name="has_included_vat" value="1" {{ $fuelRate->has_included_vat == 1 ? 'checked':'' }}>
                                      <label for="yes">Yes</label>
                                      <input type="radio" id="no" name="has_included_vat" value="0" {{ $fuelRate->has_included_vat == 0 ? 'checked':'' }}>
