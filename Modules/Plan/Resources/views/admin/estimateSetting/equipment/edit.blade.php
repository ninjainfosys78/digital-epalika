    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.plan.equipment.update',$equipment)}}" method="post">
                        @csrf
                        @method('put')
                        <fieldset class="mb-2">
                            <legend> विवरण</legend>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="activity"
                                        value="{{old('activity',$equipment->activity)}}"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="radio" id="yes" name="is_used_for_transport" value="1" {{ old('is_used_for_transport',$equipment->is_used_for_transport) == 1 ? 'checked':'' }}>
                                      <label for="yes">Yes</label>
                                      <input type="radio" id="no" name="is_used_for_transport" value="0" {{ old('is_used_for_transport',$equipment->is_used_for_transport) == 0 ? 'checked':'' }} >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    step="any"
                                        min="0"
                                        name="er"
                                        value="{{old('er',$values[0])}}"
                                        class="form-control @error('er') is-invalid @enderror"
                                        id="er"
                                        placeholder="ER"
                                    />
                                    @error('er')
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    step="any"
                                        name="gr"
                                        min="0"
                                        value="{{old('gr',$values[1])}}"
                                        class="form-control @error('gr') is-invalid @enderror"
                                        id="gr"
                                        placeholder="GR"
                                    />
                                    @error('gr')
