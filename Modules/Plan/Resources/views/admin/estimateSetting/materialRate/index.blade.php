            ...
            <div class="card  p-0">
                <div class="card-header search-card">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.plan.materialRate.create') }}" class="btn btn-sm btn-outline-primary">
                            ...
                            <tbody>
                                @forelse($materialRates as $key=>$materialRate)
                                    <tr>
                                        ...
                                        <td>
                                            <a data-bs-type="edit"
                                                href="{{ route('admin.plan.materialRate.edit', $materialRate) }}"
                                                class="btn btn-xs btn-outline-primary">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <form action="{{ route('admin.plan.materialRate.destroy', $materialRate) }}"
                                                method="post">
                                                @csrf
                                                @method('delete')
