        ...
        <div class="col-md-12">
            <div class="card p-0">
                ...
                <div class="card-body px-0">
                    <form action="{{ route('admin.plan.material.store') }}" method="post">
                        @csrf
                        ...
                        <fieldset class="mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select name="material_type_id"
                                        ...
                                        @foreach ($materialTypes as $materialType)
                                            <option {{ old('material_type_id') == $materialType->id ? 'selected' : '' }}
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="density" value="{{ old('density') }}"
