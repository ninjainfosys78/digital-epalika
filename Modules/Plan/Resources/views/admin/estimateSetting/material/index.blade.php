            ...
            <div class="card p-0">
                <div class="card-header search-card">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.plan.material.create') }}" class="btn btn-sm btn-outline-primary">
                            ...
                            <tbody>
                                @forelse($materials as $key=>$material)
                                    <tr>
                                        ...
                                        <td>
                                            <a data-bs-type="edit" href="{{ route('admin.plan.material.edit', $material) }}"
                                                class="btn btn-xs btn-outline-primary">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <form action="{{ route('admin.plan.material.destroy', $material) }}"
                                                method="post">
                                                @csrf
                                                @method('delete')
