            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">बजेट {{$type=='budgetSubHead' ? 'उप-शिर्षक':'शिर्षक'}} सम्पादन गर्नुहोस</h4>
                ...
                <div class="card-body">
                    <form action="{{route('admin.plan.budgetHead.update',[$type,$budgetHead])}}" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select
                                    ...
                                    @foreach($mainBudgetHeads as $mainBudgetHead)
                                        <option {{$mainBudgetHead->id==old('budget_head_id', $budgetHead->budget_head_id) ? 'selected' : ''}}
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="title"
                                    value="{{old('title',$budgetHead->title)}}"
