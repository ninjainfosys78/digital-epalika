            ...
            <div class="card p-0">
                <div class="card-header search-card">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="header-title">योजना {{ $type == 'planAreaSubCategory' ? 'उपक्षेत्र' : 'क्षेत्र' }} सूची
                        </h4>
                        @can('planArea_create')
                            <a href="{{ route('admin.plan.planArea.create', $type) }}" class="btn btn-sm btn-outline-primary">
                                ...
                                @forelse($planAreas as $key=>$planArea)
                                    <tr>
                                        ...
                                        <td class="d-flex gap-1">
                                            <a data-bs-type="edit"
                                                href="{{ route('admin.plan.planArea.edit', [$type, $planArea]) }}"
