    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.plan.planArea.update',[$type,$planArea])}}" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select
                                    ...
                                    @foreach($mainPlanAreas as $mainPlanArea)
                                        <option {{$mainPlanArea->id==old('plan_area_id',$planArea->plan_area_id) ? 'selected' : ''}}
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="area_name"
                                    value="{{old('area_name',$planArea->area_name)}}"
