            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> सम्पन्न हुन बाकि योजनाहरुको रिपोर्ट</li>
                    </ol>
                </div>
                <h4 class="page-title">सम्पन्न हुन बाकि योजनाहरुको रिपोर्ट </h4>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">सम्पन्न हुन बाकि योजनाहरुको रिपोर्ट</h4>
                        <div class="d-flex gap-1 justify-content-between">
                            ...
                            <x-html-to-excel
                                file-name="सम्पन्न हुन बाकि योजनाहरुको रिपोर्ट"
                ...
                <div class="card-body">
                    <div class="collapse show pb-2 border-bottom border-secondary" id="collapseFilterForm">
                        <form id="report-filter-form"
                              data-bs-url="{{route('admin.plan.report.get-incomplete-projects')}}">
                            <div class="row">
