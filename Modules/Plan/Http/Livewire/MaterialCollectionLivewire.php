...
class MaterialCollectionLivewire extends Component
{
    public $materialData;

    public $fiscalYears = [];
    public $materialRates = [];
    public $units = [];
    public array $form = [
        'fiscal_year_id' => null,
        'material_rate_id' => null,
        'unit_id' => null,
        'activity_no' => null,
        'remarks' => null,
        'collectionResources' => [],
    ...
    public function mount($materialData = null)
    {
        ...
        if (!empty($materialData)) {
            ...
            $this->form['material_rate_id'] = $materialData->material_rate_id;
        ...
        $this->materialRates = MaterialRate::all();
        $this->units = Unit::all();
    }
    ...
    protected $rules = [
        ...
        "form.material_rate_id" => ['required', 'integer', 'exists:material_rates,id,deleted_at,NULL'],
        "form.unit_id" => ['required', 'integer', 'exists:units,id,deleted_at,NULL'],
        "form.activity_no" => ['required'],
    ...
    public function save()
    {
        ...
        return redirect(route('admin.plan.materialCollection.index'));
    }
    public function render()
    {
        return view('plan::livewire.material-collection-livewire');
    }
}
