                    ...
                    <div class="row">
                        <div class="col-md-3 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input name="user.name" class="form-control @error('user.name') is-invalid @enderror"
                                    type="text" id="user.name" placeholder="प्रयोगकर्ताको नाम" wire:model="user.name">
                            </div>
                            @error('user.name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input name="user.email" class="form-control @error('user.email') is-invalid @enderror"
                                    type="email" id="user.email" placeholder="इमेल" wire:model="user.email">
                            </div>
                            @error('user.email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <select class="form-select @error('organizationDetail.district_id') is-invalid @enderror"
                                    ...
                                    @foreach ($address['organizationDistricts'] as $organizationDistrict)
                                        <option value="{{ $organizationDistrict->id }}">{{ $organizationDistrict->district }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <select class="form-select @error('organizationDetail.local_body_id') is-invalid @enderror"
                                    ...
                                    @foreach ($address['organizationLocalBodies'] as $organizationLocalBody)
                                        <option value="{{ $organizationLocalBody->id }}">
                            ...
                            <div class="col-md-8 mb-2">
                                ...
                                <input name="organizationDetail.tole"
                                    ...
                                    type="text" id="organizationDetail.tole" placeholder="गाउ/टोल"
