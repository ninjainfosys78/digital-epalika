        ...
        <div class="col-md-12">
            <div class="card">
                <div class="">
                    ...
                    <form action="{{ route('emap.admin.streetDetail.update',$streetDetail) }}" method="POST">
                        @csrf
                    @method('put')
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <label for="name" class="form-label">नाम *</label>
                                <input type="text" name="name" value="{{ old('name',$streetDetail->name) }}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="from" value="{{ old('from',$streetDetail->from) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="to" value="{{ old('to',$streetDetail->to) }}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="setback" value="{{ old('setback',$streetDetail->setback) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="street_code" value="{{ old('street_code',$streetDetail->street_code) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="wards" value="{{ old('wards',$streetDetail->wards) }}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="right_of_way" value="{{ old('right_of_way',$streetDetail->right_of_way) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="width" value="{{ old('width', $streetDetail->width) }}"
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                value="{{old('coordinates', $streetDetail->coordinates)}}">
                                    @error('coordinates')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                                <div id="map"></div>
