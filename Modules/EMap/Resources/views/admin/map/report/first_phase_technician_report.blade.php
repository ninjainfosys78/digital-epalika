...
@section('content')
    ...
    <div class="row mb-2">
        <div class="col-sm-4">
            <h4> {{\Modules\EMap\Enums\NoticeTypeEnum::THE_TECHNICIAN_WHO_COMPLETED_THE_FIRST_PHASE_OF_WORK_REPORT->label()}}</h4>
        </div>
        <div class="col-sm-8">
            <div class="text-sm-end">
                ...
                printable: 'printData',
                type: 'html',
                documentTitle: 'प्रथम चरणको कार्य सम्पन्नको नेपालगञ्ज उ.न.पा. प्रविधिकको प्रतिवेदन',
                showModal: true,
                    ...
                    <div class="card mb_30">
                        <div class="card-body p-3">
                            <div class="font-black" id="printData">
                                ...
                                <span class="mt-2">माथि उल्लेखित भवन स्थलगत निरीक्षण गर्दा प्रचलित भवन मापदण्ड एवं
                                ...
                                <span class="mt-2">प्रतिवेदन पेश गर्ने प्रविधिकको नाम, थर :<span
                                        class="underline-dotted custom-width"></span><span
                                        class="underline-dotted custom-width"></span></span><br>
                                <span class="mt-2">पद:<span class="underline-dotted custom-width"></span><span
