    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('emap.admin.eMapTemplate.update',[$eMapTemplate])}}"
                          method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="title"
                                    value="{{old('title',$eMapTemplate->title)}}"
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea name="data"
                                          id="data"
                                          cols="30" rows="10"
                                          class="form-control ckEditor @error('data') is-invalid @enderror">{{old('data',$eMapTemplate->data)}}</textarea>
                                @error('data')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
