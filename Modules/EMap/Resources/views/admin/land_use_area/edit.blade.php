    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('emap.admin.landUseArea.update',$landUseArea)}}" method="post">
                        @csrf
                        @method('put')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="title"
                                    value="{{old('title',$landUseArea->title)}}"
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="hidden" name="coordinates" id="coordinates" value="{{old('coordinates', $landUseArea->coordinates)}}">
                                <div id="map"></div>
                            </div>
                        </div>
