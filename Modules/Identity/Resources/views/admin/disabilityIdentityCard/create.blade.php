                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="name_en" class="form-control @error('name_en') is-invalid @enderror"
                                            type="text" id="name_en" value="{{ old('name_en') }}"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select @error('disability_type_id') is-invalid @enderror"
                                            name="disability_type_id" id="disability_type_id">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="father_name"
                                            ...
                                            id="father_name" placeholder="बाबुको नाम" value="{{ old('father_name') }}" />
                                        @error('father_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="mother_name"
                                            ...
                                            id="mother_name" placeholder="आमाको नाम" value="{{ old('mother_name') }}" />
                                        @error('mother_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <fieldset class="mt-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input name="tole" class="form-control  @error('tole') is-invalid @enderror"
                                        type="text" id="tole" placeholder="टोल" value="{{ old('tole') }}" />
                                    @error('tole')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('relationship_id') is-invalid @enderror"
                                            name="relationship_id" id="relationship_id">
                                            <option value="">---नाता छान्नुहोस् ---</option>
                                            @foreach ($relations as $relation)
                                                <option value="{{ $relation->id }}"
                                                    {{ $relation->id == old('relationship_id') ? 'selected' : '' }}>
                                                    {{ $relation->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="is_full_detail_required" id="is_full_detail_required"
                                            class="form-select">
                                            <option value="0"
                                                {{ old('is_full_detail_required') == '0' ? 'selected' : '' }}>
                                                छैन
                                            </option>
                                            <option value="1"
                                                {{ old('is_full_detail_required') == '1' ? 'selected' : '' }}>
                                                छ
                                            </option>
                                        </select>
                            ...
                            <div id="full-detail-fields">
                                            ...
                                            <select
                                                ...
                                                @foreach ($disabilityReasons as $disabilityReason)
                                                    <option value="{{ $disabilityReason->id }}"
                                                        {{ old('fullDetail.disability_reason_id') == $disabilityReason->id ? 'selected' : '' }}>
                                            ...
                                            <select name="fullDetail[blood_group]" id="blood_group"
                                                ...
                                                @foreach (\App\Enums\BloodGroupEnum::cases() as $case)
                                                    <option value="{{ $case->value }}"
                                                        {{ old('fullDetail.blood_group') == $case->value ? 'selected' : '' }}>
                                                        {{ $case->label() }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input name="fullDetail[material_description]"
                                                ...
                                                value="{{ old('fullDetail.material_description') }}"
                                            ...
                                            <select
                                                ...
                                                @foreach (\Modules\BusinessRegistration\Enums\Qualification::cases() as $qualification)
                                                    <option value="{{ $qualification->value }}"
                                                        {{ old('fullDetail.qualification') == $qualification->value ? 'selected' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select
                                                ...
                                                <option value="1"
                                                    {{ old('fullDetail.daily_activity') == 1 ? 'selected' : '' }}>
                                                    सक्ने
                                                </option>
                                                <option value="0"
                                                    {{ old('fullDetail.daily_activity') == 0 ? 'selected' : '' }}>
                                                    नसक्ने
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select
                                                ...
                                                <option value="1"
                                                    {{ old('fullDetail.supporting_material') == 1 ? 'selected' : '' }}>
                                                    गरेको
                                                </option>
                                                <option value="0"
                                                    {{ old('fullDetail.supporting_material') == 0 ? 'selected' : '' }}>
                                                    नगरेको
                                                </option>
                                            </select>
                                ...
                                <fieldset class="mt-3">
                                    ...
                                    @livewire('identity::task-livewire', [
                                        'tasks' => old('fullDetail.helping_task') ?? [],
                                        'hasNameGroup' => true,
                                    ])
                                </fieldset>
                                <fieldset class="mt-3">
                                    ...
                                    @livewire('identity::without-helping-task-livewire', [
                                        'tasks' => old('fullDetail.without_helping_task') ?? [],
                                        'hasNameGroup' => true,
                                    ])
                                </fieldset>
                                <div class="row">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($occupations as $occupation)
                                                            <option value="{{ $occupation->id }}"
                                                                {{ old('fullDetail.occupation_id') == $occupation->id ? 'selected' : '' }}>
