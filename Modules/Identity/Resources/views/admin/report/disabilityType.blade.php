            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">प्रकृतिको आधारमा अपाङ्गताको प्रकार अनुसार रिपोर्ट</li>
                    </ol>
                </div>
                <h4 class="page-title"> प्रकृतिको आधारमा अपाङ्गताको प्रकार अनुसार रिपोर्ट </h4>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">प्रकृतिको आधारमा अपाङ्गताको प्रकार अनुसार रिपोर्ट</h4>
                        <div class="d-flex gap-1 justify-content-between">
                            ...
                            <x-html-to-excel
                                file-name="प्रकृतिको आधारमा अपाङ्गताको प्रकार"
                                target-table="report-table"
                            />
                            <x-print-button
                                target-element="report-content"
                                title="प्रकृतिको आधारमा अपाङ्गताको प्रकार"
                            />
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="collapse show mb-2" id="collapseFilterForm">
                        <form id="report-filter-form"
                              data-bs-url="{{route('identity.admin.disability-type-report')}}">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-2">
                                    <label for="disabilityType">प्रकृतिको आधारमा अपाङ्गताको प्रकार</label>
                                    <select name="disabilityType[]" multiple data-toggle="select2"
                                            id="disabilityType" class="form-control">
                                        <option disabled>--- छान्नुहोस् ---</option>
                                        @foreach($disabilityTypes as $disabilityType)
                                            <option value="{{$disabilityType->id}}">{{$disabilityType->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive">
                        <div id="report-content" class="d-none">
                            ...
                            <table id="report-table" class="table table-sm mt-3 table-bordered">
                                ...
                                <tr>
                                    <th>क्र.सं.</th>
                                    <th>प्रकृतिको आधारमा अपाङ्गताको प्रकार</th>
