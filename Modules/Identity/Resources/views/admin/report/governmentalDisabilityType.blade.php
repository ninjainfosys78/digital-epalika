            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">अपाङ्गताको प्रकार अनुसार रिपोर्ट</li>
                    </ol>
                </div>
                <h4 class="page-title"> अपाङ्गताको प्रकार अनुसार रिपोर्ट </h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex gap-1 justify-content-between">
                            ...
                            <x-html-to-excel
                                file-name="अपाङ्गताको प्रकार अनुसार"
                                target-table="report-table"
                            />
                            <x-print-button
                                target-element="report-content"
                                title="अपाङ्गताको प्रकार अनुसार"
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="collapse show mb-2" id="collapseFilterForm">
                        <form id="report-filter-form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-2">
                                    <label for="governmentalDisabilityType">अपाङ्गताको प्रकार</label>
                                    <select name="governmentalDisabilityType[]" multiple data-toggle="select2"
                                            id="governmentalDisabilityType" class="form-control">
                                        <option disabled>--- छान्नुहोस् ---</option>
                                        @foreach($governmentalDisabilityTypes as $governmentalDisabilityType)
                                            <option value="{{$governmentalDisabilityType->id}}">{{$governmentalDisabilityType->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
