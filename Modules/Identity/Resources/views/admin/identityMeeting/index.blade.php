                    ...
                    <div class="d-flex bd-highlight justify-content-between align-items-center">
                        ...
                        <div class="p-2 bd-highlight">
                            <button type="button" class="btn btn-sm btn-outline-success" data-bs-toggle="modal"
                                ...
                                <i class="fa fa-eye"></i> निवेदक विवरण
                            </button>
                            @include('identity::admin.identityMeeting.inc.list')
                            </a>
                        </div>
                        <div class="p-2 bd-highlight"><a href="{{ route('identity.admin.identityMeeting.create') }}"
                            ...
                            @forelse($identityMeetings as $identityMeeting)
                                <tr>
                                    ...
                                    <td class="d-flex gap-1">
                                        ...
                                        <a href="{{ route('identity.admin.identityMeeting.minute', $identityMeeting) }}"
                                            type="button" class="btn btn-xs btn-outline-warning">
