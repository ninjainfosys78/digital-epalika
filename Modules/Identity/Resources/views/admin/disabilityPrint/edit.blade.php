            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">प्रिन्ट परिचय पत्र सम्पादन गर्नुहोस</h4>
                        <a href="{{ route('identity.admin.identityPrint') }}" class="btn btn-sm btn-outline-primary">
                            <i class="fa fa-plus-circle"></i> प्रिन्ट परिचय पत्र सूची
                        </a>
                    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('identity.admin.identityPrint.update', $disabilityIdentityCard) }}"
                        ...
                        <div class="card mt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="photo" accept="image/*"
                                            class="form-control @error('photo') is-invalid @enderror" type="file"
                                            id="photo" />
                                        @error('photo')
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="name" class="form-control @error('name') is-invalid @enderror"
                                            type="text" id="name" placeholder="पुरा नाम नेपालीमा"
                                            value="{{ old('name', $disabilityIdentityCard->name) }}" required />
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="name_en" class="form-control @error('name_en') is-invalid @enderror"
                                            ...
                                            placeholder="पुरा नाम (English)" required />
                                        @error('name_en')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <select class="form-select @error('gender') is-invalid @enderror" name="gender"
                                            ...
                                            @foreach (\App\Enums\Gender::cases() as $gender)
                                                <option value="{{ $gender->value }}"
                                                    {{ old('gender', $disabilityIdentityCard->gender?->value) == $gender->value ? 'selected' : '' }}>
                                                    {{ $gender->label() }}</option>
                                            @endforeach
                                        </select>
                                        @error('gender')
                                    ...
                                    <div class="col-md-4">
                                        <x-date-input-component nameNe="dob" labelNe="जन्म मिति (बि.स.) *" nameEn="dob_ad"
                                            labelEn="जन्म मिति (ई.स.)" :showEnglishDate="true"
                                            disable-after="{{ $todayDateInBS }}"
                                            disable-after-Ad="{{ today()->toDateString() }}" :editDateEn="$disabilityIdentityCard->dob_ad"
                                            :editDateNe="$disabilityIdentityCard->dob" :getTodayDate="false" />
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select @error('disability_type_id') is-invalid @enderror"
                                            name="disability_type_id" id="disability_type_id" required>
                                            <option value="">---अपांगता छान्नुहोस् ---</option>
                                            @foreach ($disabilityTypes as $disabilityType)
                                                <option value="{{ $disabilityType->id }}"
                                                    {{ old('disability_type_id', $disabilityIdentityCard->disability_type_id) == $disabilityType->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="father_name"
                                            ...
                                            id="father_name" placeholder="बाबुको नाम"
                                            value="{{ old('father_name', $disabilityIdentityCard->father_name) }}"
                                            required />
                                        @error('father_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="father_name_en"
                                            ...
                                            type="text" id="father_name_en" placeholder="बाबुको नाम (English)"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="mother_name"
                                            class="form-control @error('mother_name') is-invalid @enderror" type="text"
                                            id="mother_name" placeholder="आमाको नाम"
                                            value="{{ old('mother_name', $disabilityIdentityCard->mother_name) }}"
                                            required />
                                        @error('mother_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="mother_name_en"
                                            ...
                                            type="text" id="mother_name_en" placeholder="आमाको नाम (English)"
                            ...
                            <fieldset class="mt-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input name="tole" class="form-control  @error('tole') is-invalid @enderror"
                                        type="text" id="tole" placeholder="टोल"
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input class="form-control   @error('citizenship_no') is-invalid @enderror"
                                            type="text" id="citizenship_no" name="citizenship_no"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="birth_registration_no" class="form-label">जन्म दर्ता
                                            नं.</label>
                                        <input class="form-control @error('birth_registration_no') is-invalid @enderror"
                                            type="text" id="birth_registration_no" name="birth_registration_no"
                                            value="{{ old('birth_registration_no', $disabilityIdentityCard->birth_registration_no) }}"
                                            placeholder="जन्म दर्ता नं." required
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input name="guardian_name"
                                            ...
                                            type="text" id="guardian_name" placeholder="संरक्षकको नाम"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="guardian_name_en" class="form-label">संरक्षकको नाम
                                            (English)</label>
                                        <input name="guardian_name_en"
                                            class="form-control  @error('guardian_name_en') is-invalid @enderror"
                                            type="text" id="guardian_name_en" placeholder="संरक्षकको नाम (English)"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('relationship_id') is-invalid @enderror"
                                            name="relationship_id" id="relationship_id" required>
                                            <option value="">---नाता छान्नुहोस् ---</option>
                                            @foreach ($relations as $relation)
                                                <option value="{{ $relation->id }}"
                                                    {{ old('relationship_id', $disabilityIdentityCard->relationship_id) == $relation->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input name="phone" class="form-control  @error('phone') is-invalid @enderror"
                                            type="text" id="phone" placeholder="टेलिफोन वा मोबाईल नं."
                                            value="{{ old('phone', $disabilityIdentityCard->phone) }}" required />
                                        @error('phone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div id="full-detail-fields">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="mt-3">
                                            <legend> अपाङ्गता परिचय पत्र को लागि
                                                योग्य</legend>
                                            <div class="row">

                                                <div class="col-sm-6 mb-2">
                                                    <select name="gov_disability_type_id"
                                                        class="form-select form-select-sm" id="gov_disability_type_id">
                                                        <option value="">छान्नुहोस्</option>
                                                        @foreach ($governmentDisabilityTypes as $governmentDisabilityType)
                                                            <option value="{{ $governmentDisabilityType->id }}" 
                                                                {{ old('gov_disability_type_id', $disabilityIdentityCard->gov_disability_type_id) == $governmentDisabilityType->id ? 'selected' : '' }}>
                                                                {{ $governmentDisabilityType->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @error('gov_disability_type_id')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
