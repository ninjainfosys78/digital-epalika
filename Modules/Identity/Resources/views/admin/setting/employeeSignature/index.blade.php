                        ...
                        <tbody>
                            @forelse($employeeSignatures as $employeeSignature)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ $employeeSignature->red_signature }}"
                                    ...
                                    <td>
                                        <form
                                            ...
                                            <button
                                                ...
                                                <i
                                                    class="fa {{ $employeeSignature->status == 1 ? 'fa-check' : 'fa-times' }}"></i>
                                            </button>
                                        </form>
                                    </td>
                                    <td class="d-flex gap-1">
                                        @can('employeeSignature_edit')
                                            <a data-bs-type="edit"
                                                href="{{ route('identity.admin.setting.employeeSignature.edit', $employeeSignature) }}"
                                                type="button"
