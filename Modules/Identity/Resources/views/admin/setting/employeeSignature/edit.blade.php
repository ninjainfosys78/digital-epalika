            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">प्रसाशाक सम्पादन गर्नुहोस</h4>
                        <a href="{{route('identity.admin.setting.employeeSignature.index')}}" class="btn btn-sm btn-outline-primary">
                            <i class="fa fa-list"></i> प्रसाशाक सुची
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{route('identity.admin.setting.employeeSignature.update',$employeeSignature)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="name"
                                    value="{{old('name',$employeeSignature->name)}}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="name_en"
                                    value="{{old('name_en',$employeeSignature->name_en)}}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="designation"
                                    value="{{old('designation',$employeeSignature->designation)}}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="designation_en"
                                    value="{{old('designation_en',$employeeSignature->designation_en)}}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="pin"
                                    value="{{old('pin',$employeeSignature->pin)}}"
