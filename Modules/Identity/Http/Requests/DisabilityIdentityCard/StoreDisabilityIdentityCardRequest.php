...
class StoreDisabilityIdentityCardRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $basicValidations = [
            ...
            'birth_registration_no' => ['required_if:citizenship_no,null', Rule::unique('disability_identity_cards', 'birth_registration_no')->whereNotNull('birth_registration_no')->withoutTrashed()],
