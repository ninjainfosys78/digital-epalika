            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">लिखित जवाफ सम्पादन गर्नुहोस्</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">लिखित जवाफ सम्पादन गर्नुहोस्</h4>
                ...
                <div class="card-body">
                    <form
                        action="{{ route('admin.judicialCommittee.complaintApplication.writtenAnswer.update', [$complaintApplication,$writtenAnswer]) }}"
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea name="description"
                                          id="description"
                                          cols="30" rows="10"
                                          class="form-control ckEditor @error('description') is-invalid @enderror">{{old('description',$writtenAnswer->description)}}</textarea>
                                @error('description')
                            ...
                            <div class="col-md-6 mb-2">
                                <x-date-input-component
                                    ...
                                    :editDateNe="$writtenAnswer->submitted_date"
                                    :getTodayDate="false"
