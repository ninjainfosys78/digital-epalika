            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">मिलापत्र</li>
                    </ol>
                </div>
            ...
            <div class="card p-0">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="header-title">मिलापत्र</h4>
                        <div class="d-flex justify-content-between gap-1">
                            <x-print-button title="मिलापत्र" target-element="print-content" />
                            @can('conciliation_edit')
                                <a href="{{ route('admin.judicialCommittee.complaintApplication.conciliation.create', $complaintApplication) }}"
                ...
                <div class="card-body px-0">
                    <div class="mx-4 p-2 border border-secondary">
                        <div id="print-content">
                            {!! $complaintApplication->conciliation->description ?? '' !!}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        @foreach ($complaintApplication->conciliation->files ?? collect() as $file)
