                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            @can('complaintApplication_access')
                                                <a data-bs-type="edit"
                                                    href="{{ route('admin.judicialCommittee.complaintApplication.show', $complaintApplication) }}"
                                            ...
                                            @can('complaintApplication_edit')
                                                <a data-bs-type="edit"
                                                    href="{{ route('admin.judicialCommittee.complaintApplication.edit', $complaintApplication) }}"
