    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form
                        action="{{ route('admin.judicialCommittee.complaintApplication.defendantIssuedDeadline.update', [$complaintApplication,$defendantIssuedDeadline]) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <x-date-input-component
                                    ...
                                    :editDateNe="$defendantIssuedDeadline->submitted_date" :getTodayDate="false" />
                            </div>
