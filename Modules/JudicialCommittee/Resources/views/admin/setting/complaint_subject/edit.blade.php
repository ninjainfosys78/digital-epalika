            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">उजुरी विषय सम्पादन गर्नुहोस् </h4>
                ...
                <div class="card-body">
                    <form action="{{route('admin.judicialCommittee.setting.complaintSubject.update',$complaintSubject)}}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="lawsuit_nature_id" class="form-select" id="lawsuit_nature_id">
                                    ...
                                    @foreach($lawsuitNatures as $lawsuitNature)
                                        <option
                                            {{$lawsuitNature->id==old('lawsuit_nature_id',$complaintSubject->lawsuit_nature_id) ? 'selected' : ''}}
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="subject"
                                    value="{{old('subject',$complaintSubject->subject)}}"
