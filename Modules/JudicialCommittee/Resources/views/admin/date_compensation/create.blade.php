                    ...
                    <form
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <x-date-input-component nameNe="decision_date" labelNe="निर्णय हुने मिति *"
                                    :getTodayDate="false" />
                            </div>
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="decision_subject" class="form-control"
                                    value="{{ old('decision_subject') }}" id="decision_subject"
                                    placeholder="निर्णय हुने विषय" required />
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="time" name="decision_time" class="form-control"
                                    value="{{ old('decision_time') }}" id="decision_time" placeholder="निर्णय हुने समय "
                                    required />
                                @error('decision_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
