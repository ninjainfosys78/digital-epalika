    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.recommendation.setting.recommendationCategory.recommendationTemplate.update',[$type,$recommendationCategory,$recommendationTemplate])}}"
                          method="post"
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="title"
                                    value="{{old('title',$recommendationTemplate->title)}}"
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea name="data"
                                          ...
                                          required
                                          cols="30" rows="10"
                                          class="form-control ckEditor @error('data') is-invalid @enderror">{{old('data',$recommendationTemplate->data)}}</textarea>
                                @error('data')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
