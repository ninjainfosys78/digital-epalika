            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">सिफारिस श्रेणी</li>
                    </ol>
                </div>
                <h4 class="page-title">सिफारिस श्रेणी</h4>
            </div>
        </div>
    </div>
                                        ...
                                        <td>
                                            ...
                                            @can('recommendationCategory_access')
                                                <a data-bs-type="edit" class="{{ get_setting('Pin') ? 'confirm_pin' : '' }}"
                                                    ...
                                                    <i
                                                        class="fa fa-2x {{ $recommendationCategory->status == 'active' ? 'fa-toggle-on ' : ' fa-toggle-off' }}"></i>
                                                </a>
                                            @endcan
                                        </td>
