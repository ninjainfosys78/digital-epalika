            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> वडा नं अनुसार</li>
                    </ol>
                </div>
                <h4 class="page-title"> वडा नं अनुसार </h4>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title"> वडा नं अनुसार</h4>
                        <div class="d-flex gap-1 justify-content-between">
                            ...
                            <x-html-to-excel
                                file-name="वडा नं अनुसार रिपोर्ट"
                ...
                <div class="card-body">
                    <div class="collapse show mb-2" id="collapseFilterForm">
                        <form id="report-filter-form" data-bs-url="{{route('admin.recommendation.report.ward-wise-report')}}">
                            <div class="row">
