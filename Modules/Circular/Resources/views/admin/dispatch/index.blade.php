                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex gap-1">
                                    <a data-bs-type="edit" href="{{route('admin.circular.dispatch.print', $dispatch)}}"
                                    ...
                                    <a data-bs-type="edit" href="{{route('admin.circular.dispatch.report', $dispatch)}}"
                                        class="btn btn-xs btn-outline-info {{get_setting('Pin')?'confirm_pin' : ''}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    @endif
                                    @can('dispatch_access')
                                    <a data-bs-type="edit" href="{{route('admin.circular.dispatch.show', $dispatch)}}"
                                    ...
                                    @endcan
                                    @can('dispatch_delete')
                                    <form action="{{route('admin.circular.dispatch.destroy',$dispatch)}}" method="post">
                                        @csrf
                                        @method('delete')
                            ...
                            @empty
                            <tr>
                                <td colspan="8" class="text-center text-danger">तालिकामा कुनै डाटा उपलब्ध छैन !!!</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
