                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        ...
                                        value="{{old('registration_no',$registration->registration_no)}}"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="letter_number"
                                        value="{{old('letter_number',$registration->letter_number)}}"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="sender_name"
                                        value="{{old('sender_name',$registration->sender_name)}}"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="subject"
                                        value="{{old('subject',$registration->subject)}}"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea name="remarks"
                                              ...
                                              placeholder="कैफ़ियत">{{old('remarks',$registration->remarks)}}</textarea>
                                    @error('remarks')
                                    <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="receiver_name"
                                        value="{{old('receiver_name',$registration->receiver_name)}}"
