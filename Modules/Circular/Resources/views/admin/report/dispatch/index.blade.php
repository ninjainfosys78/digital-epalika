...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title"> चलानी रिपोर्ट </h4>
        </div>
    </div>
</div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-1 justify-content-between">
                        <button class="btn btn-sm btn-light" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseFilterForm" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <x-html-to-excel file-name="चलानी रिपोर्ट" target-table="report-table" />
                        <x-print-button target-element="report-table" title="चलानी रिपोर्ट" :header-required="true" />
                    </div>
                </div>
            </div>
                                ...
                                <fieldset class="border p-2 mb-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <x-date-input-component nameNe="from_dispatch_date" labelNe="मिति देखि"
                                                nameEn="en_from_dispatch_date" labelEn="From Date"
                                                :get-today-date="false" />
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <x-date-input-component nameNe="to_dispatch_date" labelNe="मिति सम्म"
