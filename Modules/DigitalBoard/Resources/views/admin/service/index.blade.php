                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-custom">
                            ...
                            <tbody>
                                @forelse($services as $key=>$service)
                                    <tr>
                                        ...
                                        <td class="d-flex gap-1">
                                            ...
                                            <a data-bs-type="edit"
                                                href="{{ route('admin.digitalBoard.service.show', $service) }}"
                                            ...
                                            <a data-bs-type="edit"
                                                href="{{ route('admin.digitalBoard.service.edit', $service) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-danger">तालिकामा कुनै डाटा उपलब्ध छैन !!!
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
