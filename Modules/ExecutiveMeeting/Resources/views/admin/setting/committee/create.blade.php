            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">समिति थप्नुहोस्</li>
                    </ol>
                </div>
            ...
            <div class="card p-0">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="header-title">समिति थप्नुहोस्</h4>
                        <a href="{{ route('admin.executiveMeeting.setting.committee.index') }}"
                ...
                <div class="card-body px-0">
                    <form action="{{ route('admin.executiveMeeting.setting.committee.store') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="committee_type_id" id="committee_type_id" class="form-select" required>
                                    ...
                                    @foreach ($committeeTypes as $committeeType)
                                        <option {{ $committeeType->id == old('committee_type_id') ? 'selected' : '' }}
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="committee_name" value="{{ old('committee_name') }}"
                                    class="form-control @error('committee_name') is-invalid @enderror" id="committee_name"
