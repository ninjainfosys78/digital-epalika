    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.businessRegistration.setting.objectTransactionSubCategory.update',$objectTransactionSubCategory)}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="title"
                                        value="{{old('title',$objectTransactionSubCategory->title)}}"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <select name="object_transaction_id" id="object_transaction_id" class="form-control">
                                        ...
                                        @foreach($all_objectTransactions as $all_objectTransaction)
                                            <option value="{{$all_objectTransaction->id}}"{{old('object_transaction_id',$all_objectTransaction->id)== $objectTransactionSubCategory->object_transaction_id ? 'selected':''}}>{{$all_objectTransaction->title}}
                                            </option>
                                        @endforeach
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="category_a"
                                        value="{{old('category_a',$objectTransactionSubCategory->category_a)}}"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="category_b"
                                        value="{{old('category_b',$objectTransactionSubCategory->category_b)}}"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="category_c"
                                        value="{{old('category_c',$objectTransactionSubCategory->category_c)}}"
