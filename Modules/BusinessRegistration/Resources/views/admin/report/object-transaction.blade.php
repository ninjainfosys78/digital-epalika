            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> कारोबार गर्ने मुख्य सेवा वा बस्तु अनुसार रिपोर्ट</li>
                    </ol>
                </div>
                <h4 class="page-title"> कारोबार गर्ने मुख्य सेवा वा बस्तु अनुसार रिपोर्ट </h4>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">कारोबार गर्ने मुख्य सेवा वा बस्तु अनुसार रिपोर्ट</h4>
                ...
                <div class="card-body">
                    <div class="collapse show mb-2" id="collapseFilterForm">
                        <form id="report-filter-form"
                              data-bs-url="{{route('admin.businessRegistration.report.object-transaction-report')}}">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-2">
                                    <label for="object_transaction">व्यवसायको कारोबार गर्ने मुख्य सेवा वा बस्तु
                                    </label>
                    ...
                    <div class="table-responsive">
                        <div id="report-content" class="d-none">
                            ...
                            <table id="report-table" class="table table-sm mt-3 table-bordered">
                                ...
                                <tr>
                                    <th>क्र.सं.</th>
                                    <th>व्यवसायको कारोबार गर्ने मुख्य सेवा वा बस्तु</th>
