                            ...
                            <tbody>
                                @forelse($grantDetails as $grantDetail)
                                    <tr>
                                        ...
                                        <td>{{ $grantDetail->grant->grant_program_name ?? '' }}
                                            ({{ $grantDetail->grant->fiscalYear->title ?? '' }})</td>
                                        ...
                                        <td class="text-center">{{ $grantDetail->localBody->local_body ?? '' }} -
                                            {{ $grantDetail->ward_no }}</td>
                                        <td>{{ $grantDetail->contact }}</td>
                                        <td class="d-flex gap-1">
                                            @can('grantDetail_edit')
                                                <a data-bs-type="edit"
                                                    href="{{ route('admin.grant.grantDetail.edit', $grantDetail) }}"
                                            ...
                                            @can('grantDetail_access')
                                                <a data-bs-type="edit"
                                                    href="{{ route('admin.grant.grantDetail.show', $grantDetail) }}"
                                                    class="btn btn-xs btn-outline-primary {{ get_setting('Pin') ? 'confirm_pin' : '' }}"
                                                    title="हेर्नुहोस्">
                                                    <i class="fa fa-eye"></i>
                                                </a>
