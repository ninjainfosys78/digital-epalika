    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.grant.setting.helplessnessType.update', $helplessnessType) }}"
                        method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="text" name="helplessness_type"
                                    value="{{ old('helplessness_type', $helplessnessType->helplessness_type) }}"
                                    class="form-control @error('helplessness_type') is-invalid @enderror"
                                    id="helplessness_type" 
                                    placeholder="असहायताको प्रकार" required />
