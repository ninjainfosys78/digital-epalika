                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex gap-1">
                                            @can('cooperative_access')
                                                <a data-bs-type="edit"
                                                    href="{{ route('admin.grant.cooperative.show', $cooperative) }}"
                                            ...
                                            @can('cooperative_edit')
                                                <a data-bs-type="edit"
                                                    href="{{ route('admin.grant.cooperative.edit', $cooperative) }}"
                                                    class="btn btn-xs btn-outline-primary {{ get_setting('Pin') ? 'confirm_pin' : '' }}"
                                            ...
                                            @can('cooperative_delete')
                                                <form action="{{ route('admin.grant.cooperative.destroy', $cooperative) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
