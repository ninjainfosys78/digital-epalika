            ...
            <div class="card p-0">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.grant.cooperative.index') }}" class="btn btn-sm btn-outline-primary">
                ...
                <div class="card-body px-0">
                    <form action="{{ route('admin.grant.cooperative.store') }}" method="post">
                        ...
                        <fieldset>
                            <legend>
                                <h4 class="text-info"> सहकारीको विवरण </h4>
                            </legend>
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="name" class="form-label">सहकारी नाम <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="name" value="{{ old('name') }}"
                                        class="form-control @error('name') is-invalid @enderror" id="name"
                                        placeholder="सहकारी नाम" required />
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    <label for="name" class="form-label">सहकारी प्रकार <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4 mb-2">
                                    <label for="registration_no" class="form-label">दर्ता नं<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="registration_no" value="{{ old('registration_no') }}"
                                        ...
                                        id="registration_no" placeholder="दर्ता नं" required />
                                    @error('registration_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4 mb-2">
                                    <x-date-input-component nameNe="c_registration_date" labelNe="दर्ता मिति *"
                                        nameEn="en_c_registration_date" labelEn="Registration Date" :getTodayDate="false" />
                                </div>
                                <div class="col-md-4 mb-2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="affiliation_id" id="affiliation_id"
                                        ...
                                        @foreach ($affiliations as $affiliation)
                                            <option {{ $affiliation->id == old('affiliation_id') ? 'selected' : '' }}
                                ...
                                <div class="col-md-12 ">
                                    <label for="objective" class="form-label">उद्देश्य<span
                                            class="text-danger">*</span></label>
                                    <textarea name="objective" id="objective" class="form-control" placeholder="objective.." cols="50" rows="4"></textarea>
                                    @error('objective')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="village" id="village"
                                        ...
                                        value="{{ old('village') }}" placeholder="गाउँ">
                                </div>
                                @error('village')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="tole" id="tole"
                                        ...
                                        value="{{ old('tole') }}" placeholder="टोल">
                                </div>
                                @error('tole')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="input-group">
                                    <select name="farmers[]" multiple data-toggle="select2" id="farmers"
                                        class="form-select" aria-describedby="button-farmer">
