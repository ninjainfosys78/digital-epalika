            ...
            <div class="card p-0">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.revenue.setting.revenue.index') }}" class="btn btn-sm btn-outline-primary">
                            <i class="fa fa-list"></i> राजस्वको शिर्षक सूची
                        </a>
                    </div>
                </div>
                <div class="card-body px-0">
                    <form action="{{ route('admin.revenue.setting.revenue.store') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="revenue_category_id"
                                    ...
                                    @foreach ($revenueCategories as $revenueCategory)
                                        @include('revenue::admin.setting.revenue.option', [
