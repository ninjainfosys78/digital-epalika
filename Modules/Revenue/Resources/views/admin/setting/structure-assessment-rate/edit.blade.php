            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">संरचनाको मुल्यांकन सम्पादन गर्नुहोस</h4>
                ...
                <div class="card-body">
                    @livewire('revenue::structure-assessment-rate-livewire',['structureAssessmentRate'=>$structureAssessmentRate])
                </div>
            </div>
        </div>
    </div>
