                    ...
                    <form action="{{ route('admin.revenue.invoice.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                <x-date-input-component nameNe="payment_date" labelNe="मिति *" nameEn="payment_date_en"
                                    labelEn="Date" />
                            </div>
                            <div class="col-md-4 mb-2">
                                <label for="tax_payer_id" class="form-label">करदाता *</label>
                                <select name="tax_payer_id" class="form-select @error('tax_payer_id') is-invalid @enderror"
